...
// import Profile from "@/app/Buyer/clientComponents/Profile/page";
...
export default function Header() {
  ...
  useEffect(() => {
    const user = localStorage.getItem("user"); // Check if user exists in local storage
    if (user) {
  ...
  const handleProfileClick = () => {
    if (isAuthenticated) {
      router.push("/Buyer/clientComponents/Profile/page"); // Navigate to Profile Page
    } else {
  ...
  const handleLoginSuccess = () => {
    ...
    localStorage.setItem("user", "true"); // Store authentication status
    router.push("/Buyer/clientComponents/Profile/page"); // Redirect to profile page after login
  };
